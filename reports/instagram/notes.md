...
- RN markers detected: yes, from sampled `10.10.0 (50667367)` through `58.0 (120248682)`
...
|---|---:|---|---|---|---:|
| unknown |  | low | build 1.8.7, `2948163`, `2010-09-27T16:39:00` | 7.7.2 (15484445), `813610568`, `2015-09-30T21:36:32` | 3 |
| <=0.59.x |  | medium | 10.10.0 (50667367), `821056195`, `2017-02-23T14:15:16` | 58.0 (120248682), `828138988`, `2018-08-09T18:31:38` | 2 |
| unknown |  | low | 118.0 (180988914), `833368709`, `2019-11-01T17:18:24` | 430.0.0 (972915403), `885526725`, `2026-05-16T18:55:26` | 7 |

## Unresolved Gaps

- The RN-introduction window is between sampled external IDs `813610568` and `821056195`.
- The RN-removal or marker-disappearance window is between sampled external IDs `828138988` and `833368709`.
...
Refine the two Instagram boundary windows by downloading midpoint or adjacent versions between `813610568` -> `821056195` and `828138988` -> `833368709`.
