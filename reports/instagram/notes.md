...
- RN markers detected: yes, from sampled `10.10.0 (50667367)` through `89.0 (149781277)`
...
|---|---:|---|---|---|---:|
| unknown |  | low | build 1.8.7, `2948163`, `2010-09-27T16:39:00` | 7.19.1 (26398067), `816877594`, `2016-03-28T12:45:08` | 4 |
...
- The RN-introduction window is between sampled external IDs `816877594` and `821056195`.
- The RN-removal or marker-disappearance window is between sampled external IDs `830905744` and `833368709`.
...
Refine the two Instagram boundary windows by downloading midpoint or adjacent versions between `816877594` -> `821056195` and `830905744` -> `833368709`.
